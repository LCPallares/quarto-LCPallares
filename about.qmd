...
image: assets/images/profile1.png  # Solo una definición, sin "/" inicial
about:
  id: edu-exp
  template: solana
  image-width: 9em
...
![Análisis de Ventas](/projects/analisis_predictivo_ventas/ventas.png){.project-img}  
**Análisis Predictivo de Ventas**  
[{{< iconify octicon:repo-16 >}} Repositorio](https://github.com/...){.btn}  
[{{< iconify octicon:report-16 >}} Reporte](/informes/ventas.html){.btn}

![Dashboard Logístico](/projects/dashboard_logistica/logistica.jpg){.project-img}  
